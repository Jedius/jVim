...
syn match jVar /\zs\<[a-z_][A-Za-z_$0-9]*\>\ze \?[=+-]/ display
...
syn match OrangeB /\<\%(return\|break\|continue\|throw\|cb\|next\)\>/
syn match RedB /\<\%(err\|error\)\>/
syn match PinkB /\<\%(req\|document\|window\)\>/
syn match PinkBL /\<\%(res\)\>/
...
syn match coffeeException /\<\%(try\|catch\|finally\|console.log\|log.info\|log.warn\)\>/ display
hi def link coffeeException Exception

syn match coffeeKeyword /\<\%(new\|in\|of\|by\|not\|class\|extends\|require\|super\|do\)\>/
\                       display
...
"if !exists("coffee_no_reserved_words_error")
  "syn match coffeeReservedError /\<\%(case\|default\|function\|void\|with\|const\|let\|enum\|export\|import\|native\|__hasProp\|__extends\|__slice\|__bind\|__indexOf\)\>/
  "\                             display
